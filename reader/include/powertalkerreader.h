#ifndef POWERTALKERREADER_H
#define POWERTALKERREADER_H

#include <QAbstractItemModel>
#include "defs.h"

class PowerTalkerReader : public QAbstractItemModel {
    Q_OBJECT
private:
    QString filename;
    bool is_loaded;
...
public:
    ...
    explicit PowerTalkerReader(QObject *parent = 0);
    PowerTalkerReader(const QString &filename, Snotra::database_args args, QObject *parent = 0);
    ~PowerTalkerReader();
